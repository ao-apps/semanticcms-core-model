...
package com.semanticcms.core.model.book;
...
@WebServlet("/core/model/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    HttpServletUtil.sendRedirect(
        ...
        "/core/model/apidocs/com.semanticcms.core.model/com" + Objects.toString(req.getPathInfo(), ""),
